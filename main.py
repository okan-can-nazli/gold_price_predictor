...
prices_list = [price / 31.1034768 for price in raw_prices]
...
for day in range(days_between):
    ...
    print(f"After day {day+1}: ${real_price:.4f} (per gram)")
    
print(f"\nPredicted gold price per gram on {input_date}: ${real_price:.4f}")